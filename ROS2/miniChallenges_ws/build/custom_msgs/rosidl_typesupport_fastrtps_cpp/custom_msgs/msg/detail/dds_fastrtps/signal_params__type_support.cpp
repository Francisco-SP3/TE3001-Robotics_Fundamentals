...
#include "custom_msgs/msg/detail/signal_params__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::SignalParams;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::SignalParams *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::SignalParams *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_SignalParams__handle;
}
